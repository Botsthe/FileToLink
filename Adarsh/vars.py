...
class Var(object):
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://aman727587:aman@cluster0.dgzdlwb.mongodb.net/?retryWrites=true&w=majority'))
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'Latestmoviesupdates0'))
    BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002062708890")).split())) 
